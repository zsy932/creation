// 胡同小馆内容
const hutongContentHTML = `// 从原始index.html中提取的完整JavaScript代码
...
const smartContentHTML = `
        ...
        <section class="special-card">
          <div class="special-header" style="display: flex; justify-content: space-between; align-items: center;">
            <div class="special-title">菜品模块</div>
          ...
          <div class="special-content">
            <div class="text-center text-neutral-500 py-8">
              <i class="ri-restaurant-line text-4xl mb-4"></i>
              <p class="text-lg">点击上方「完整菜单」按钮查看所有菜品</p>
            </div>
          </div>
        </section>`;
